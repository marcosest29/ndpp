...
@Component({
  selector: 'app-tplocales',
  templateUrl: './tplocales.component.html',
  styleUrls: ['./tplocales.component.css']
})
export class TplocalesComponent implements OnInit, OnChanges {
