...
@Component({
  selector: 'app-tpfiltros',
  templateUrl: './tpfiltros.component.html',
  styleUrls: ['./tpfiltros.component.css']
})
export class TpfiltrosComponent implements OnInit , OnChanges {
  filtrosInfo: any;
